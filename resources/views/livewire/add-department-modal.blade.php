<div class="bg-white">
    <h2 class="text-lg font-semibold font-display text-gray-700 tracking-tight mx-3 py-1.5">Add department
    </h2>
    ...
    <div class="bg-slate-100">
        <div class="px-4 py-4">
            ...
            <x-button sm wire:click="saveDepartment" class="ml-2" blue label="Save" />
        </div>
    </div>
</div>
