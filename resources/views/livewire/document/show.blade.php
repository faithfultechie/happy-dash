        ...
        <div>
            <div class="border-b border-gray-200 bg-white">
                <div class="flex flex-wrap items-center justify-between sm:flex-nowrap mb-5">
                    <div>
                        <h3 class="text-base font-semibold leading-7 text-gray-800 uppercase">{{ $document->title }}
                        </h3>
                    </div>
                ...
                <li class="flex items-center justify-between gap-x-6 py-5">
                    <div class="min-w-0">
                        <div class="flex items-start gap-x-3">
                            <p class="text-sm font-medium leading-6 text-gray-500">Document Status</p>
                            <p
                        ...
                        <div class="mt-2 flex items-center gap-x-2 text-xs leading-5 text-gray-500">
                            ...
                            <p class="truncate">Expires on <span
                                    class="text-sm font-medium">{{ date('d M, Y', strtotime($document->expiry_date)) }}</span>
                            </p>
                        </div>
                    </div>
                </li>
                                    ...
                                    <li class="flex items-center justify-between py-4 pl-4 pr-5 text-sm leading-6">
                                        <div class="flex w-0 flex-1 items-center">
                                            ...
                                            <div class="ml-4 flex min-w-0 flex-1 gap-2">
                                                <span
                                                    class="truncate font-medium">{{ $document->document_filename }}</span>
                                                <span
                                                    class="flex-shrink-0 text-gray-400">{{ number_format($document->document_filesize / 1048576, 2) }}
                                                    mb</span>
                                            </div>
                                        </div>
                                        <div class="ml-4 flex-shrink-0">
                                            <a href="{{ asset('uploads/' . $document->document_filepath) }}"
