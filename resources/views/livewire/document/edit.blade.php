...
<div>
    <div>
        <x-page-heading pageHeading="Edit Document" />
    </div>
        ...
        <div class="w-full md:w-9/12">
            ...
            <form wire:submit="save" method="POST">
                ...
                <div class="grid gap-5 grid-cols-1 md:grid-cols-3 mt-5">
                    ...
                    <div>
                        <x-input label="Priority" type="text" wire:model="priority" />
                    </div>
                    <div>
                ...
                <div class="grid gap-5 grid-cols-1 md:grid-cols-2 mt-5">
                    ...
                    FilePond.create($refs.input, {
                        ...
                        files: [{
                            source: '{{ asset('uploads/' . $document->document_filepath) }}',
                            options: {
                                type: 'local'
                            },
                        }],
                        ...
                        <x-input label="Attachment" type="file" wire:model="document_filepath" x-ref="input" />
