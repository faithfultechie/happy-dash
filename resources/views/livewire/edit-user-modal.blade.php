<div class="bg-white">
    <h2 class="text-lg font-semibold font-display text-gray-700 tracking-tight mx-3 py-1.5">Edit user
    </h2>
        ...
        <form wire:submit="save">
            <div x-show.transition="current === 1" class="mt-2">
                <div class="bg-blue-50 px-2 py-4 mx-2 my-4 rounded-md text-xs flex items-center max-w-lg">
                    ...
                    <span class="text-blue-700">Upon password update, user will be prompted to change their
                ...
                <div class="bg-slate-100">
                    <div class="px-4 py-4">
                        ...
                        <x-button sm wire:click="save" class="ml-2" blue label="Save" />
                    </div>
                </div>
            </div>
                        ...
                        @foreach ($permissions as $permission)
                            <div class="m-2">
                                <x-checkbox id="{{ $permission->id }}" wire:model="selectedPermissions"
                                    :checked="in_array($permission->id, $selectedPermissions)" label="{{ $permission->description }}" primary
