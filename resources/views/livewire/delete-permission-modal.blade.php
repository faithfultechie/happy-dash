...
<div class="bg-white">
    <h2 class="text-lg font-semibold font-display text-gray-700 tracking-tight mx-3 py-1.5">Delete permission
    </h2>
    ...
    <div class="flex items-start px-5 py-5">
        ...
        <div class="text-center ml-4 sm:text-left">
            <p class="text-gray-500">This will permanently delete <span class="font-medium">{{ $permission->name }}</span>
