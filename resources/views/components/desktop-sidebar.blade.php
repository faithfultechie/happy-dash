        ...
        <nav class="flex flex-1 flex-col">
            <ul role="list">
                ...
                <x-navigation-submenu
                    ...
                    3.375 0 0 0-3.375-3.375h-1.5A1.125 1.125 0 0 1 13.5 7.125v-1.5a3.375 3.375
                     0 0 0-3.375-3.375H8.25m6.75 12H9m1.5-12H5.625c-.621 0-1.125.504-1.125
                    ...
                    @endphp
                    @foreach ($sortedSubmenuItems as $label => $route)
                        <x-navigation-submenu-link :route="$route">{{ $label }}</x-navigation-submenu-link>
                    @endforeach
                </x-navigation-submenu>
